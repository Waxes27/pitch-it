...
* [JDBC API](https://docs.spring.io/spring-boot/docs/2.7.10/reference/htmlsingle/#data.sql)
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/docs/2.7.10/reference/htmlsingle/#messaging.jms.activemq)
